  ...
  return (
    <Modal closeModal={closeModal}> 
			<div className="DeletaPaletaModal">
				<h2>Confirmação</h2>
				<p>Você realmente deseja remover <b>{paletaParaDeletar.titulo}</b> do cardápio?</p>
				...
				<div>
					<button onClick={() => handleDelete(paletaParaDeletar)} className="DeletaPaletaModal__confirmar"> Confirmar </button>
					<button onClick={closeModal} className="DeletaPaletaModal__cancelar"> Cancelar </button>
				</div>
			</div>
    </Modal>
  );
